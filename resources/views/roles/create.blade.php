<x-app-layout>
    <div class="flex items-center justify-between mb-6">
        <div>
            <h4 class="text-xl font-bold text-yovel-ink tracking-tight">Tambah Peran</h4>
    ...
    <div class="card-surface overflow-hidden w-full shrink-0">
        <form action="{{ route('roles.store') }}" method="POST" x-data="{ submitting: false }" @submit="submitting = true" class="p-6 md:p-8 space-y-8">
            ...
            <div class="pt-4 border-t border-[#E9E9E7]">
                ...
                {{-- Disclaimer jujur: izin di bawah TERSIMPAN di database, tapi routing
                     masih memakai string nama role hardcoded. Sampai Gate-based authorization
                     dibangun, checkbox ini hanya untuk dokumentasi — bukan penegakan akses nyata.
                     @see §2.4 audit navigasi --}}
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-4 gap-x-8">
                    ...
                    <label class="flex items-start gap-3 cursor-pointer group">
                        <input type="checkbox" name="permissions[can_access_pos]" value="1" {{ old('permissions.can_access_pos') ? 'checked' : '' }} class="mt-0.5 w-4 h-4 rounded border-[#E9E9E7] text-yovel-ink focus:ring-[#37352F] transition-colors">
                        <div>
                    ...
                    <label class="flex items-start gap-3 cursor-pointer group">
                        <input type="checkbox" name="permissions[can_void_order]" value="1" {{ old('permissions.can_void_order') ? 'checked' : '' }} class="mt-0.5 w-4 h-4 rounded border-[#E9E9E7] text-yovel-ink focus:ring-[#37352F] transition-colors">
                        <div>
                    ...
                    <label class="flex items-start gap-3 cursor-pointer group">
                        <input type="checkbox" name="permissions[can_give_discount]" value="1" {{ old('permissions.can_give_discount') ? 'checked' : '' }} class="mt-0.5 w-4 h-4 rounded border-[#E9E9E7] text-yovel-ink focus:ring-[#37352F] transition-colors">
                        <div>
                    ...
                    <!-- Dapur & Manajemen -->
                    <label class="flex items-start gap-3 cursor-pointer group">
                        <input type="checkbox" name="permissions[can_access_kds]" value="1" {{ old('permissions.can_access_kds') ? 'checked' : '' }} class="mt-0.5 w-4 h-4 rounded border-[#E9E9E7] text-yovel-ink focus:ring-[#37352F] transition-colors">
                        <div>
                    ...
                    <label class="flex items-start gap-3 cursor-pointer group">
                        <input type="checkbox" name="permissions[can_manage_menu]" value="1" {{ old('permissions.can_manage_menu') ? 'checked' : '' }} class="mt-0.5 w-4 h-4 rounded border-[#E9E9E7] text-yovel-ink focus:ring-[#37352F] transition-colors">
                        <div>
                    ...
                    <label class="flex items-start gap-3 cursor-pointer group">
                        <input type="checkbox" name="permissions[can_view_reports]" value="1" {{ old('permissions.can_view_reports') ? 'checked' : '' }} class="mt-0.5 w-4 h-4 rounded border-[#E9E9E7] text-yovel-ink focus:ring-[#37352F] transition-colors">
                        <div>
