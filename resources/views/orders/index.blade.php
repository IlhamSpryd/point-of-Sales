<x-app-layout>
    ...
    <div class="flex flex-col items-center justify-center py-20 text-center animate-fade-in">
        ...
        <a href="{{ route('dashboard') }}" class="mt-8 px-6 py-3 bg-[#37352F] text-white font-bold rounded-xl hover:bg-black transition-colors shadow-sm inline-flex items-center gap-2" wire:navigate>
