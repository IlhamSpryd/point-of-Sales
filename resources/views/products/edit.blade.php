<x-app-layout>
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('products.index') }}" class="flex items-center gap-2 px-4 py-2 bg-white hover:bg-[#F7F7F5] border border-[#E9E9E7] text-[#37352F] text-sm font-medium rounded-xl transition-all duration-200 shadow-sm active:scale-95">
            ...
            <div>
                ...
                <div class="mt-1 flex items-center justify-center px-6 pt-5 pb-6 border-2 border-[#E9E9E7] border-dashed rounded-xl transition-colors duration-200 hover:border-[#C4C3C0] bg-[#F7F7F5]">
                    <div class="space-y-1 text-center">
                        ...
                        <p class="text-xs text-[#9B9A97] mt-2" id="file-name">Opsional. PNG, JPG hingga 2MB</p>
                    </div>
                </div>
                @error('product_photo')
                    <p class="text-sm text-rose-500 mt-1.5 font-medium">{{ $message }}</p>
