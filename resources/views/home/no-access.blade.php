<x-app-layout>
    <div class="flex h-full flex-col items-center justify-center text-center px-6 py-16">
        ...
        <h1 class="text-xl font-bold text-[#37352F]">Belum ada modul untuk peran Anda</h1>
        ...
        <form method="POST" action="{{ route('logout') }}" class="mt-6">
            @csrf
            <button type="submit"
                class="inline-flex items-center gap-2 rounded-xl border border-[#E9E9E7] bg-white px-5 py-2.5 text-sm font-semibold text-[#37352F] hover:bg-[#F7F7F5] transition-all active:scale-95 shadow-sm">
