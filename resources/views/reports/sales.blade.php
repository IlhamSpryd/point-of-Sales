<x-app-layout>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
            <h4 class="text-xl font-bold text-yovel-ink tracking-tight">{{ $title }}</h4>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-8">
        ...
        <div class="card-surface p-6">
            ...
            <h3 class="text-2xl font-extrabold text-yovel-ink tracking-tight">Rp {{ number_format($dailySales->total, 0, ',', '.') }}</h3>
        ...
        <div class="card-surface p-6">
            ...
            <h3 class="text-2xl font-extrabold text-yovel-ink tracking-tight">Rp {{ number_format($weeklySales->total, 0, ',', '.') }}</h3>
        ...
        <div class="card-surface p-6">
            ...
            <h3 class="text-2xl font-extrabold text-yovel-ink tracking-tight">Rp {{ number_format($monthlySales->total, 0, ',', '.') }}</h3>
