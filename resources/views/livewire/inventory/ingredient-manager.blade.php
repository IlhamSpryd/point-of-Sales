                    ...
                    @forelse ($ingredients as $item)
                        <tr class="hover:bg-[#F7F7F5]/50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                @else
                                    <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-xs font-medium bg-gray-100 text-gray-700 border border-gray-200">
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full border border-gray-200">
                <form wire:submit.prevent="save">
                            ...
                            <div class="pt-2">
                                <label class="flex items-center cursor-pointer">
                                    <div class="relative">
                                        ...
                                        <div class="block bg-gray-200 w-10 h-6 rounded-full transition-colors duration-300" :class="{ 'bg-emerald-500': @entangle('is_active') }"></div>
                    ...
                    <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-end gap-3 rounded-b-2xl">
                        <button type="button" wire:click="$set('showModal', false)" class="px-4 py-2 bg-white border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
                            Batal
                        </button>
                ...
                <form wire:submit.prevent="saveAdjustment">
                    <div class="bg-white px-6 pt-6 pb-6">
                        <div class="mb-5 flex justify-between items-center">
                            ...
                            <button type="button" wire:click="$set('showAdjustModal', false)" class="text-gray-400 hover:text-gray-500">
                                <span class="material-symbols-rounded text-[20px]">close</span>
                            </button>
                        </div>
                    ...
                    <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-end gap-3 rounded-b-2xl">
                        <button type="button" wire:click="$set('showAdjustModal', false)" class="px-4 py-2 bg-white border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
                            Batal
                        </button>
                        <button type="submit" class="px-4 py-2 bg-gray-900 border border-transparent rounded-lg text-sm font-medium text-white hover:bg-gray-800 transition-colors">
                            Simpan Perubahan
