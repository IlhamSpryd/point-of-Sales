            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-zinc-50/50 dark:bg-zinc-800/50">
                        ...
                        <th class="px-6 py-4 text-xs font-semibold text-zinc-500 uppercase tracking-wider">Contact Info</th>
                    ...
                    @forelse($users as $user)
                        <tr class="hover:bg-zinc-50/50 dark:hover:bg-zinc-800/50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <div class="text-xs text-zinc-400 mt-0.5">{{ $user->phone_number }}</div>
                                @endif
                            </td>
                            <td class="px-6 py-4">
                                @if($user->role)
                            ...
                            <td class="px-6 py-4 text-right space-x-2">
                                <a href="{{ route('users.edit', $user->id) }}" class="p-1.5 text-zinc-400 hover:text-blue-600 transition-colors inline-block"><i class="bi bi-pencil-square"></i></a>
                                @if(auth()->id() !== $user->id)
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-8 text-center text-zinc-500 text-sm">
                                <div class="flex flex-col items-center justify-center">
                                    <i class="bi bi-people text-4xl mb-3 text-zinc-400"></i>
                                    <p>No users found.</p>
                                </div>
                            </td>
                        </tr>
